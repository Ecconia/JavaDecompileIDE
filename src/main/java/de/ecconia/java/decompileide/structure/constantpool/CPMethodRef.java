...
public class CPMethodRef extends ConstantPoolEntry
{
	...
	public CPMethodRef(DataInput d) throws IOException
	{
	...
	{
		return "MethodRef: " + className + "@" + classIndex + " " + name + ":" + descriptor + "@" + nameAndTypeIndex;
	}
}
